...
class SaveAddressScreen extends StatelessWidget
{
  ...
  getUserLocationAddress() async
  {
    ...
    try {
      ...
      String fullAddress = '${pMark.subThoroughfare} ${pMark
      ...
      '${pMark.subThoroughfare} ${pMark.thoroughfare}, ${pMark
          .subLocality} ${pMark.locality}';
      _city.text =
      '${pMark.subAdministrativeArea}, ${pMark.administrativeArea} ${pMark
          .postalCode}';
  ...
  Widget build(BuildContext context)
  {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text("Save Now",style: TextStyle(fontFamily: "Inter"),),
